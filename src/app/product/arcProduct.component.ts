...
@Component({
  templateUrl: 'arcProduct.component.html'
})

export class ArcProductComponent implements OnInit, OnChanges {
  ...
  onSubmit() {
    const pid = this.selectedProduct == null ? 0 : +this.selectedProduct;
